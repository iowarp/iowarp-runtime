...
const inline char* kChiServerDefaultConfigStr =
    ...
    "  # The size of the shared memory region to allocate for general data "
    "structures\n"
    "  shm_size: 0g\n"
    ...
    "rpc:\n"
    "  # A path to a file containing a list of server names, 1 per line. If "
    "your\n"
    "  # servers are named according to a pattern (e.g., server-1, server-2, "
    "etc.),\n"
    "  # prefer the `rpc_server_base_name` and `rpc_host_number_range` "
    "options. If this\n"
    "  # option is not empty, it will override anything in "
    ...
    "\n"
    "  # The RPC protocol. This must come from the documentation of the "
    "specific RPC\n"
    "  # library in use.\n"
