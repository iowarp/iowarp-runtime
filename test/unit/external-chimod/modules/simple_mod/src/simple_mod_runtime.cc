...
void Runtime::SaveIn(chi::u32 method, chi::TaskSaveInArchive& archive,
  ...
  switch (method) {
    case Method::kCreate: {
      auto create_task = task_ptr.Cast<CreateTask>();
      archive(create_task);
      break;
    }
    case Method::kDestroy: {
      auto destroy_task = task_ptr.Cast<DestroyTask>();
      archive(destroy_task);
      break;
    }
    case Method::kFlush: {
      auto flush_task = task_ptr.Cast<FlushTask>();
      archive(flush_task);
      break;
    }
  }
...
void Runtime::NewCopy(chi::u32 method, 
  ...
  switch (method) {
    case Method::kCreate: {
      auto orig = orig_task.Cast<CreateTask>();
      auto dup = dup_task.Cast<CreateTask>();
      dup->shm_strong_copy_main(*orig);
      break;
    }
    case Method::kDestroy: {
      auto orig = orig_task.Cast<DestroyTask>();
      auto dup = dup_task.Cast<DestroyTask>();
      dup->shm_strong_copy_main(*orig);
      break;
    }
    case Method::kFlush: {
      auto orig = orig_task.Cast<FlushTask>();
      auto dup = dup_task.Cast<FlushTask>();
      dup->shm_strong_copy_main(*orig);
      break;
    }
  }
