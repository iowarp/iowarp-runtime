...
void Del(const hipc::MemContext &mctx, u32 method, Task *task) override {
  switch (method) {
    ...
    case Method::kAllocate: {
      CHI_CLIENT->DelTask<AllocateTask>(mctx,
                                        reinterpret_cast<AllocateTask *>(task));
      break;
    }
    case Method::kFree: {
...
void CopyStart(u32 method, const Task *orig_task, Task *dup_task,
  ...
  switch (method) {
    ...
    case Method::kAllocate: {
      chi::CALL_COPY_START(reinterpret_cast<const AllocateTask *>(orig_task),
                           reinterpret_cast<AllocateTask *>(dup_task), deep);
      break;
    }
    case Method::kFree: {
      chi::CALL_COPY_START(reinterpret_cast<const FreeTask *>(orig_task),
                           reinterpret_cast<FreeTask *>(dup_task), deep);
      break;
    }
    case Method::kWrite: {
      chi::CALL_COPY_START(reinterpret_cast<const WriteTask *>(orig_task),
                           reinterpret_cast<WriteTask *>(dup_task), deep);
      break;
    }
    case Method::kRead: {
      chi::CALL_COPY_START(reinterpret_cast<const ReadTask *>(orig_task),
  ...
  switch (method) {
    ...
    case Method::kAllocate: {
      chi::CALL_NEW_COPY_START(
          reinterpret_cast<const AllocateTask *>(orig_task), dup_task, deep);
      break;
    }
    case Method::kFree: {
      chi::CALL_NEW_COPY_START(reinterpret_cast<const FreeTask *>(orig_task),
                               dup_task, deep);
      break;
    }
    case Method::kWrite: {
      chi::CALL_NEW_COPY_START(reinterpret_cast<const WriteTask *>(orig_task),
                               dup_task, deep);
      break;
    }
    case Method::kRead: {
      chi::CALL_NEW_COPY_START(reinterpret_cast<const ReadTask *>(orig_task),
                               dup_task, deep);
      break;
    }
    case Method::kPollStats: {
...
TaskPointer LoadStart(u32 method, BinaryInputArchive<true> &ar) override {
  ...
  switch (method) {
    ...
    case Method::kAllocate: {
      task_ptr.ptr_ =
          CHI_CLIENT->NewEmptyTask<AllocateTask>(HSHM_MCTX, task_ptr.shm_);
      ar >> *reinterpret_cast<AllocateTask *>(task_ptr.ptr_);
      break;
    }
    case Method::kFree: {
      task_ptr.ptr_ =
          CHI_CLIENT->NewEmptyTask<FreeTask>(HSHM_MCTX, task_ptr.shm_);
      ar >> *reinterpret_cast<FreeTask *>(task_ptr.ptr_);
      break;
    }
    case Method::kWrite: {
      task_ptr.ptr_ =
          CHI_CLIENT->NewEmptyTask<WriteTask>(HSHM_MCTX, task_ptr.shm_);
      ar >> *reinterpret_cast<WriteTask *>(task_ptr.ptr_);
      break;
    }
    case Method::kRead: {
      task_ptr.ptr_ =
          CHI_CLIENT->NewEmptyTask<ReadTask>(HSHM_MCTX, task_ptr.shm_);
