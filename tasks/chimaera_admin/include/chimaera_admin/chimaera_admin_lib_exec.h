...
void Run(u32 method, Task *task, RunContext &rctx) override {
  switch (method) {
    ...
    case Method::kSetWorkOrchQueuePolicy: {
      SetWorkOrchQueuePolicy(
          reinterpret_cast<SetWorkOrchQueuePolicyTask *>(task), rctx);
      break;
    }
...
void Monitor(MonitorModeId mode, MethodId method, Task *task,
  ...
  switch (method) {
    ...
    case Method::kDestroyContainer: {
      MonitorDestroyContainer(
          mode, reinterpret_cast<DestroyContainerTask *>(task), rctx);
      break;
    }
    case Method::kRegisterModule: {
      MonitorRegisterModule(mode, reinterpret_cast<RegisterModuleTask *>(task),
                            rctx);
      break;
    }
    case Method::kDestroyModule: {
      MonitorDestroyModule(mode, reinterpret_cast<DestroyModuleTask *>(task),
                           rctx);
      break;
    }
    case Method::kUpgradeModule: {
      MonitorUpgradeModule(mode, reinterpret_cast<UpgradeModuleTask *>(task),
                           rctx);
      break;
    }
    case Method::kGetPoolId: {
    ...
    case Method::kSetWorkOrchQueuePolicy: {
      MonitorSetWorkOrchQueuePolicy(
          mode, reinterpret_cast<SetWorkOrchQueuePolicyTask *>(task), rctx);
      break;
    }
    case Method::kSetWorkOrchProcPolicy: {
      MonitorSetWorkOrchProcPolicy(
          mode, reinterpret_cast<SetWorkOrchProcPolicyTask *>(task), rctx);
      break;
    }
    case Method::kFlush: {
    ...
    case Method::kGetDomainSize: {
      MonitorGetDomainSize(mode, reinterpret_cast<GetDomainSizeTask *>(task),
                           rctx);
      break;
    }
    case Method::kUpdateDomain: {
      MonitorUpdateDomain(mode, reinterpret_cast<UpdateDomainTask *>(task),
                          rctx);
      break;
    }
    case Method::kPollStats: {
...
void Del(const hipc::MemContext &mctx, u32 method, Task *task) override {
  switch (method) {
    ...
    case Method::kCreatePool: {
      CHI_CLIENT->DelTask<CreatePoolTask>(
          mctx, reinterpret_cast<CreatePoolTask *>(task));
      break;
    }
    case Method::kDestroyContainer: {
      CHI_CLIENT->DelTask<DestroyContainerTask>(
          mctx, reinterpret_cast<DestroyContainerTask *>(task));
      break;
    }
    case Method::kRegisterModule: {
      CHI_CLIENT->DelTask<RegisterModuleTask>(
          mctx, reinterpret_cast<RegisterModuleTask *>(task));
      break;
    }
    case Method::kDestroyModule: {
      CHI_CLIENT->DelTask<DestroyModuleTask>(
          mctx, reinterpret_cast<DestroyModuleTask *>(task));
      break;
    }
    case Method::kUpgradeModule: {
      CHI_CLIENT->DelTask<UpgradeModuleTask>(
          mctx, reinterpret_cast<UpgradeModuleTask *>(task));
      break;
    }
    case Method::kGetPoolId: {
      CHI_CLIENT->DelTask<GetPoolIdTask>(
          mctx, reinterpret_cast<GetPoolIdTask *>(task));
      break;
    }
    case Method::kStopRuntime: {
      CHI_CLIENT->DelTask<StopRuntimeTask>(
          mctx, reinterpret_cast<StopRuntimeTask *>(task));
      break;
    }
    case Method::kSetWorkOrchQueuePolicy: {
      CHI_CLIENT->DelTask<SetWorkOrchQueuePolicyTask>(
          mctx, reinterpret_cast<SetWorkOrchQueuePolicyTask *>(task));
      break;
    }
    case Method::kSetWorkOrchProcPolicy: {
      CHI_CLIENT->DelTask<SetWorkOrchProcPolicyTask>(
          mctx, reinterpret_cast<SetWorkOrchProcPolicyTask *>(task));
      break;
    }
    case Method::kFlush: {
    ...
    case Method::kGetDomainSize: {
      CHI_CLIENT->DelTask<GetDomainSizeTask>(
          mctx, reinterpret_cast<GetDomainSizeTask *>(task));
      break;
    }
    case Method::kUpdateDomain: {
      CHI_CLIENT->DelTask<UpdateDomainTask>(
          mctx, reinterpret_cast<UpdateDomainTask *>(task));
      break;
    }
    case Method::kPollStats: {
      CHI_CLIENT->DelTask<PollStatsTask>(
          mctx, reinterpret_cast<PollStatsTask *>(task));
      break;
    }
  }
}
...
void CopyStart(u32 method, const Task *orig_task, Task *dup_task,
  ...
  switch (method) {
    ...
    case Method::kCreatePool: {
      chi::CALL_COPY_START(reinterpret_cast<const CreatePoolTask *>(orig_task),
    ...
    case Method::kGetPoolId: {
      chi::CALL_COPY_START(reinterpret_cast<const GetPoolIdTask *>(orig_task),
                           reinterpret_cast<GetPoolIdTask *>(dup_task), deep);
      break;
    }
    case Method::kStopRuntime: {
      chi::CALL_COPY_START(reinterpret_cast<const StopRuntimeTask *>(orig_task),
    ...
    case Method::kFlush: {
      chi::CALL_COPY_START(reinterpret_cast<const FlushTask *>(orig_task),
    ...
    case Method::kPollStats: {
      chi::CALL_COPY_START(reinterpret_cast<const PollStatsTask *>(orig_task),
  ...
  switch (method) {
    ...
    case Method::kCreatePool: {
      chi::CALL_NEW_COPY_START(
          reinterpret_cast<const CreatePoolTask *>(orig_task), dup_task, deep);
      break;
    }
    case Method::kDestroyContainer: {
      chi::CALL_NEW_COPY_START(
          reinterpret_cast<const DestroyContainerTask *>(orig_task), dup_task,
          deep);
      break;
    }
    case Method::kRegisterModule: {
      chi::CALL_NEW_COPY_START(
          reinterpret_cast<const RegisterModuleTask *>(orig_task), dup_task,
          deep);
      break;
    }
    case Method::kDestroyModule: {
      chi::CALL_NEW_COPY_START(
          reinterpret_cast<const DestroyModuleTask *>(orig_task), dup_task,
          deep);
      break;
    }
    case Method::kUpgradeModule: {
      chi::CALL_NEW_COPY_START(
          reinterpret_cast<const UpgradeModuleTask *>(orig_task), dup_task,
          deep);
      break;
    }
    case Method::kGetPoolId: {
      chi::CALL_NEW_COPY_START(
          reinterpret_cast<const GetPoolIdTask *>(orig_task), dup_task, deep);
      break;
    }
    case Method::kStopRuntime: {
      chi::CALL_NEW_COPY_START(
          reinterpret_cast<const StopRuntimeTask *>(orig_task), dup_task, deep);
      break;
    }
    case Method::kSetWorkOrchQueuePolicy: {
      chi::CALL_NEW_COPY_START(
    ...
    case Method::kFlush: {
      chi::CALL_NEW_COPY_START(reinterpret_cast<const FlushTask *>(orig_task),
                               dup_task, deep);
      break;
    }
    case Method::kGetDomainSize: {
      chi::CALL_NEW_COPY_START(
          reinterpret_cast<const GetDomainSizeTask *>(orig_task), dup_task,
          deep);
      break;
    }
    case Method::kUpdateDomain: {
      chi::CALL_NEW_COPY_START(
          reinterpret_cast<const UpdateDomainTask *>(orig_task), dup_task,
          deep);
      break;
    }
    case Method::kPollStats: {
      chi::CALL_NEW_COPY_START(
          reinterpret_cast<const PollStatsTask *>(orig_task), dup_task, deep);
      break;
    }
  }
}
...
TaskPointer LoadStart(u32 method, BinaryInputArchive<true> &ar) override {
  ...
  switch (method) {
    ...
    case Method::kCreatePool: {
      task_ptr.ptr_ =
          CHI_CLIENT->NewEmptyTask<CreatePoolTask>(HSHM_MCTX, task_ptr.shm_);
    ...
    case Method::kDestroyModule: {
      task_ptr.ptr_ =
          CHI_CLIENT->NewEmptyTask<DestroyModuleTask>(HSHM_MCTX, task_ptr.shm_);
      ar >> *reinterpret_cast<DestroyModuleTask *>(task_ptr.ptr_);
      break;
    }
    case Method::kUpgradeModule: {
      task_ptr.ptr_ =
          CHI_CLIENT->NewEmptyTask<UpgradeModuleTask>(HSHM_MCTX, task_ptr.shm_);
      ar >> *reinterpret_cast<UpgradeModuleTask *>(task_ptr.ptr_);
      break;
    }
    case Method::kGetPoolId: {
      task_ptr.ptr_ =
          CHI_CLIENT->NewEmptyTask<GetPoolIdTask>(HSHM_MCTX, task_ptr.shm_);
      ar >> *reinterpret_cast<GetPoolIdTask *>(task_ptr.ptr_);
      break;
    }
    case Method::kStopRuntime: {
      task_ptr.ptr_ =
          CHI_CLIENT->NewEmptyTask<StopRuntimeTask>(HSHM_MCTX, task_ptr.shm_);
    ...
    case Method::kFlush: {
      task_ptr.ptr_ =
          CHI_CLIENT->NewEmptyTask<FlushTask>(HSHM_MCTX, task_ptr.shm_);
      ar >> *reinterpret_cast<FlushTask *>(task_ptr.ptr_);
      break;
    }
    case Method::kGetDomainSize: {
      task_ptr.ptr_ =
          CHI_CLIENT->NewEmptyTask<GetDomainSizeTask>(HSHM_MCTX, task_ptr.shm_);
      ar >> *reinterpret_cast<GetDomainSizeTask *>(task_ptr.ptr_);
      break;
    }
    case Method::kUpdateDomain: {
      task_ptr.ptr_ =
          CHI_CLIENT->NewEmptyTask<UpdateDomainTask>(HSHM_MCTX, task_ptr.shm_);
      ar >> *reinterpret_cast<UpdateDomainTask *>(task_ptr.ptr_);
      break;
    }
    case Method::kPollStats: {
      task_ptr.ptr_ =
          CHI_CLIENT->NewEmptyTask<PollStatsTask>(HSHM_MCTX, task_ptr.shm_);
