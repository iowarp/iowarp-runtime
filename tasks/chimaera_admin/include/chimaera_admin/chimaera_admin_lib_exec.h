#ifndef HRUN_CHM_ADMIN_LIB_EXEC_H_
#define HRUN_CHM_ADMIN_LIB_EXEC_H_
...
void Dup(u32 method, Task *orig_task, std::vector<LPointer<Task>> &dups) override {
  switch (method) {
    case Method::kCreateTaskState: {
      chm::CALL_DUPLICATE(reinterpret_cast<CreateTaskStateTask*>(orig_task), dups);
      break;
    }
    case Method::kDestroyTaskState: {
      chm::CALL_DUPLICATE(reinterpret_cast<DestroyTaskStateTask*>(orig_task), dups);
      break;
    }
    case Method::kRegisterTaskLib: {
      chm::CALL_DUPLICATE(reinterpret_cast<RegisterTaskLibTask*>(orig_task), dups);
      break;
    }
    case Method::kDestroyTaskLib: {
      chm::CALL_DUPLICATE(reinterpret_cast<DestroyTaskLibTask*>(orig_task), dups);
      break;
    }
    case Method::kGetOrCreateTaskStateId: {
      chm::CALL_DUPLICATE(reinterpret_cast<GetOrCreateTaskStateIdTask*>(orig_task), dups);
      break;
    }
    case Method::kGetTaskStateId: {
      chm::CALL_DUPLICATE(reinterpret_cast<GetTaskStateIdTask*>(orig_task), dups);
      break;
    }
    case Method::kStopRuntime: {
      chm::CALL_DUPLICATE(reinterpret_cast<StopRuntimeTask*>(orig_task), dups);
      break;
    }
    case Method::kSetWorkOrchQueuePolicy: {
      chm::CALL_DUPLICATE(reinterpret_cast<SetWorkOrchQueuePolicyTask*>(orig_task), dups);
      break;
    }
    case Method::kSetWorkOrchProcPolicy: {
      chm::CALL_DUPLICATE(reinterpret_cast<SetWorkOrchProcPolicyTask*>(orig_task), dups);
      break;
    }
    case Method::kFlush: {
      chm::CALL_DUPLICATE(reinterpret_cast<FlushTask*>(orig_task), dups);
      break;
    }
  }
}
...
void DupEnd(u32 method, u32 replica, Task *orig_task, Task *dup_task) override {
  switch (method) {
    case Method::kCreateTaskState: {
      chm::CALL_DUPLICATE_END(replica, reinterpret_cast<CreateTaskStateTask*>(orig_task), reinterpret_cast<CreateTaskStateTask*>(dup_task));
      break;
    }
    case Method::kDestroyTaskState: {
      chm::CALL_DUPLICATE_END(replica, reinterpret_cast<DestroyTaskStateTask*>(orig_task), reinterpret_cast<DestroyTaskStateTask*>(dup_task));
      break;
    }
    case Method::kRegisterTaskLib: {
      chm::CALL_DUPLICATE_END(replica, reinterpret_cast<RegisterTaskLibTask*>(orig_task), reinterpret_cast<RegisterTaskLibTask*>(dup_task));
      break;
    }
    case Method::kDestroyTaskLib: {
      chm::CALL_DUPLICATE_END(replica, reinterpret_cast<DestroyTaskLibTask*>(orig_task), reinterpret_cast<DestroyTaskLibTask*>(dup_task));
      break;
    }
    case Method::kGetOrCreateTaskStateId: {
      chm::CALL_DUPLICATE_END(replica, reinterpret_cast<GetOrCreateTaskStateIdTask*>(orig_task), reinterpret_cast<GetOrCreateTaskStateIdTask*>(dup_task));
      break;
    }
    case Method::kGetTaskStateId: {
      chm::CALL_DUPLICATE_END(replica, reinterpret_cast<GetTaskStateIdTask*>(orig_task), reinterpret_cast<GetTaskStateIdTask*>(dup_task));
      break;
    }
    case Method::kStopRuntime: {
      chm::CALL_DUPLICATE_END(replica, reinterpret_cast<StopRuntimeTask*>(orig_task), reinterpret_cast<StopRuntimeTask*>(dup_task));
      break;
    }
    case Method::kSetWorkOrchQueuePolicy: {
      chm::CALL_DUPLICATE_END(replica, reinterpret_cast<SetWorkOrchQueuePolicyTask*>(orig_task), reinterpret_cast<SetWorkOrchQueuePolicyTask*>(dup_task));
      break;
    }
    case Method::kSetWorkOrchProcPolicy: {
      chm::CALL_DUPLICATE_END(replica, reinterpret_cast<SetWorkOrchProcPolicyTask*>(orig_task), reinterpret_cast<SetWorkOrchProcPolicyTask*>(dup_task));
      break;
    }
    case Method::kFlush: {
      chm::CALL_DUPLICATE_END(replica, reinterpret_cast<FlushTask*>(orig_task), reinterpret_cast<FlushTask*>(dup_task));
      break;
    }
  }
}
...
void ReplicateStart(u32 method, u32 count, Task *task) override {
  switch (method) {
    case Method::kCreateTaskState: {
      chm::CALL_REPLICA_START(count, reinterpret_cast<CreateTaskStateTask*>(task));
      break;
    }
    case Method::kDestroyTaskState: {
      chm::CALL_REPLICA_START(count, reinterpret_cast<DestroyTaskStateTask*>(task));
      break;
    }
    case Method::kRegisterTaskLib: {
      chm::CALL_REPLICA_START(count, reinterpret_cast<RegisterTaskLibTask*>(task));
      break;
    }
    case Method::kDestroyTaskLib: {
      chm::CALL_REPLICA_START(count, reinterpret_cast<DestroyTaskLibTask*>(task));
      break;
    }
    case Method::kGetOrCreateTaskStateId: {
      chm::CALL_REPLICA_START(count, reinterpret_cast<GetOrCreateTaskStateIdTask*>(task));
      break;
    }
    case Method::kGetTaskStateId: {
      chm::CALL_REPLICA_START(count, reinterpret_cast<GetTaskStateIdTask*>(task));
      break;
    }
    case Method::kStopRuntime: {
      chm::CALL_REPLICA_START(count, reinterpret_cast<StopRuntimeTask*>(task));
      break;
    }
    case Method::kSetWorkOrchQueuePolicy: {
      chm::CALL_REPLICA_START(count, reinterpret_cast<SetWorkOrchQueuePolicyTask*>(task));
      break;
    }
    case Method::kSetWorkOrchProcPolicy: {
      chm::CALL_REPLICA_START(count, reinterpret_cast<SetWorkOrchProcPolicyTask*>(task));
      break;
    }
    case Method::kFlush: {
      chm::CALL_REPLICA_START(count, reinterpret_cast<FlushTask*>(task));
      break;
    }
  }
}
...
void ReplicateEnd(u32 method, Task *task) override {
  switch (method) {
    case Method::kCreateTaskState: {
      chm::CALL_REPLICA_END(reinterpret_cast<CreateTaskStateTask*>(task));
      break;
    }
    case Method::kDestroyTaskState: {
      chm::CALL_REPLICA_END(reinterpret_cast<DestroyTaskStateTask*>(task));
      break;
    }
    case Method::kRegisterTaskLib: {
      chm::CALL_REPLICA_END(reinterpret_cast<RegisterTaskLibTask*>(task));
      break;
    }
    case Method::kDestroyTaskLib: {
      chm::CALL_REPLICA_END(reinterpret_cast<DestroyTaskLibTask*>(task));
      break;
    }
    case Method::kGetOrCreateTaskStateId: {
      chm::CALL_REPLICA_END(reinterpret_cast<GetOrCreateTaskStateIdTask*>(task));
      break;
    }
    case Method::kGetTaskStateId: {
      chm::CALL_REPLICA_END(reinterpret_cast<GetTaskStateIdTask*>(task));
      break;
    }
    case Method::kStopRuntime: {
      chm::CALL_REPLICA_END(reinterpret_cast<StopRuntimeTask*>(task));
      break;
    }
    case Method::kSetWorkOrchQueuePolicy: {
      chm::CALL_REPLICA_END(reinterpret_cast<SetWorkOrchQueuePolicyTask*>(task));
      break;
    }
    case Method::kSetWorkOrchProcPolicy: {
      chm::CALL_REPLICA_END(reinterpret_cast<SetWorkOrchProcPolicyTask*>(task));
      break;
    }
    case Method::kFlush: {
      chm::CALL_REPLICA_END(reinterpret_cast<FlushTask*>(task));
      break;
    }
  }
}
